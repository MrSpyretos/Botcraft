        ...
        static async Task Main()
        {
            var builder = new HostBuilder()
                ...
                .ConfigureServices((context, services) =>
                {
                    ...
                    .AddSingleton<Images>()
                    .AddSingleton<Server>()
                    .AddSingleton<RankServices>()
                    .AddSingleton<ServerServices>()
                    .AddSingleton<ConfigurationServices>()
                    .AddSingleton<OxfordApi>()
                    .AddSingleton<YoutubeApi>()
                    .AddSingleton<GiphyApi>()
                    .AddSingleton<AwayServices>()
                    .AddSingleton<AutoRoleServices>()
                    .AddSingleton<ChannelServices>();
                })
                .UseConsoleLifetime();
